-- 数据的准备
	...
	create table students(
	    ...
	    height decimal(5,2),
	    gender enum('男','女','中性','保密') default '保密', -- enum枚举 只能从中选取
	    cls_id int unsigned default 0,
	    is_delete bit default 0  -- 默认为bit(1)一个比特 要么1 要么0
	);
...
-- 条件查询
	-- 比较运算符
		...
		-- >
		-- 查询大于18岁的信息
		select * from students where age>18;  -- *所有字段
	...
	-- 逻辑运算符
		...
		-- 失败select * from students where age>18 and <28;  and左右条件要写全
		...
		-- select * from students where not age>18 and gender=2;（优先级)不加括号就只有否定他后面相邻的条件
